...
#define PwmLdd3_PERIOD_VALUE 0x8E0CUL  /* Initial period value in ticks of the timer. */
#define PwmLdd3_PERIOD_VALUE_0 0x8E0CUL /* Period value in ticks of the timer in clock configuration 0. */
